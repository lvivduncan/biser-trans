...
// levus-onslide
class LevusOnslide {
    constructor(s) { this.slider = document.querySelector(s), this.slides = this.slider.querySelectorAll("article"), this.left = this.slider.querySelector("#levus-left"), this.right = this.slider.querySelector("#levus-right"), this.length = this.slides.length - 1, this.first = this.slides[0], this.cnt = 0 }
    click() { this.left.addEventListener("click", () => { setTimeout(() => { this.slides.forEach(s => s.removeAttribute("class")), this.cnt < this.length ? this.cnt++ : this.cnt = 0, this.slides[this.cnt].classList.add("show") }, 500) }), this.right.addEventListener("click", () => { setTimeout(() => { this.slides.forEach(s => s.removeAttribute("class")), 0 === this.cnt ? this.cnt = this.length : this.cnt--, this.slides[this.cnt].classList.add("show") }, 500) }) }
    arrow() { this.left.classList.add("hide"), this.right.classList.add("hide"), this.slider.addEventListener("mouseover", () => { this.left.removeAttribute("class"), this.right.removeAttribute("class") }), this.slider.addEventListener("mouseout", () => { this.left.classList.add("hide"), this.right.classList.add("hide") }) }
    autoScroll() { setInterval(() => { this.slides.forEach(s => s.removeAttribute("class")), this.cnt < this.length ? this.cnt++ : this.cnt = 0, this.slides[this.cnt].classList.add("show") }, 8e3) }
    init() { this.click(), this.first.classList.add("show"), this.arrow(), window.addEventListener("resize", () => window.innerWidth < 1200 && this.autoScroll()) }
}
...
// levus-animate
{
    const height = document.documentElement.clientHeight,
        elements = document.querySelectorAll(".levus-animate");
...
! function(e, t) {
    ...
    return function(e) {
        ...
        function n(o) { if (t[o]) return t[o].exports; var s = t[o] = { i: o, l: !1, exports: {} }; return e[o].call(s.exports, s, s.exports, n), s.l = !0, s.exports }
        return n.m = e, n.c = t, n.d = function(e, t, o) { n.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: o }) }, n.r = function(e) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }) }, n.t = function(e, t) {
            ...
            if (n.r(o), Object.defineProperty(o, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e)
                for (var s in e) n.d(o, s, function(t) { return e[t] }.bind(null, s));
            return o
        ...
        function L(e) {
            var t, n = e.props,
                o = 0,
                s = {};
            this.getSourceTypeFromLocalStorageByUrl = function(e) { return t[e] ? t[e] : i(e) }, this.handleReceivedSourceTypeForUrl = function(e, n) { void 0 !== s[n] && (o--, s[n] = e, 0 === o && (! function(e, t) { for (var n in t) e[n] = t[n] }(t, s), localStorage.setItem("fslightbox-types", JSON.stringify(t)))) };
            var i = function(e) { o++, s[e] = !1 };
        ...
        function F(e, t, n, o) {
            ...
            var a = function() { i[t].style.width = c * r + "px", i[t].style.height = c + "px" }
        }
        ...
        function C(e, t, n, o) {
            var s = this,
                ...
                l = r.sourcesOuters,
                u = e.resolve;
            this.runNormalLoadActions = function() { c[t].classList.add(x), a[t].classList.add(m), l[t].removeChild(l[t].firstChild) }, this.runInitialLoadActions = function() {
        ...
        function I(e, t) {
            ...
            }, this.handleCustomLoad = function() { setTimeout((function() { o.handleCustomLoad = c(s[t].offsetWidth, s[t].offsetHeight) })) };
            var c = function(e, n) { var o = r(C, [t, e, n]); return o.runInitialLoadActions(), o.runNormalLoadActions }
        }
        ...
        function T(e, t) {
            var n = e.collections,
                ...
                c = e.props,
                a = c.sources;
            i[t] = document.createElement("video"), i[t].className = y, i[t].src = a[t], i[t].onloadedmetadata = function(e) { o[t].handleVideoLoad(e) }, i[t].controls = !0, c.videosPosters[t] && (i[t].poster = c.videosPosters[t]);
        ...
        function z(e) {
            ...
            this.runActionsForSourceTypeAndIndex = function(t, r) {
                ...
                o[r] = function() { return c(e, r) }, s.displaySourcesWhichShouldBeDisplayed()
            }
        }

        function H() {
            var e, t, n, o, s, i = { isUrlYoutubeOne: function(e) { var t = document.createElement("a"); return t.href = e, "www.youtube.com" === t.hostname }, getTypeFromResponseContentType: function(e) { return e.slice(0, e.indexOf("/")) } };
            this.setUrlToCheck = function(t) { e = t }, this.getSourceType = function(t) {
        ...
        function k(e, t, n) {
            var o = e.props,
                ...
                r = o.sources,
                c = e.resolve;
            this.getTypeSetByClientForIndex = function(e) { var t; return s && s[e] ? t = s[e] : i && (t = i), t }, this.retrieveTypeWithXhrForIndex = function(e) {
                var o = c(H);
        ...
        function M(e) {
            ...
            o.className = "".concat(s, "nav"), n.appendChild(o), P(e, o), t.length > 1 && function(e, t) {
                ...
                u.innerHTML = o.length, i.appendChild(r), r.appendChild(c), r.appendChild(l), r.appendChild(u), t.appendChild(i), setTimeout((function() { r.offsetWidth > 55 && (i.style.justifyContent = "flex-start") }))
            }(e, o)
        }
        ...
        function j(e, t) {
            var n = this,
                ...
                s = e.props,
                i = 0;
            this.byValue = function(e) { return i = e, n }, this.negative = function() { r(-c()) }, this.zero = function() { r(0) }, this.positive = function() { r(c()) };
            var r = function(e) { o[t].style.transform = "translateX(".concat(e + i, "px)"), i = 0 },
        ...
        function _(e) {
            ...
            var i = function(e, n) { t[e].byValue(o.swipedX)[n]() }
        }
        ...
        function G(e) {
            var t = e.collections.sourcesOutersTransformers,
                ...
                o = e.elements.sourcesOuters,
                s = e.stageIndexes;
            this.runPositiveSwipedXActions = function() { void 0 === s.previous ? i("zero") : (i("positive"), n.changeTo(s.previous), i("zero")) }, this.runNegativeSwipedXActions = function() { void 0 === s.next ? i("zero") : (i("negative"), n.changeTo(s.next), i("zero")) };
            var i = function(e) { o[s.current].classList.add(u), t[s.current][e]() }
        }
        ...
        function $(e) {
            ...
            n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function(e, t) { for (var n = 0; n < o[e].length; n++) B(o[e][n], t) },
                ...
                function(e) {
                    ...
                    }, t.exitFullscreen = function() { document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen() }
                }(e),
                function(e) {
                    var t = e.core,
                ...
                function(e) {
                    var t = e.core.lightboxCloser,
                        n = (0, e.resolve)(V);
                    t.close = function() { n.isLightboxFadingOut || n.runActions() }
                }(e), te(e),
                function(e) {
                    var t = e.data,
                        n = e.core.scrollbarRecompensor;
                    n.addRecompense = function() { "complete" === document.readyState ? o() : addEventListener("load", (function() { o(), n.addRecompense = o })) };
                    var o = function() { document.body.offsetHeight > innerHeight && (document.body.style.marginRight = t.scrollbarWidth + "px") };
                    n.removeRecompense = function() { document.body.style.removeProperty("margin-right") }
                }(e),
                function(e) {
                    var t = e.core,
                        ...
                        s = t.stageManager;
                    e.props.sources.length > 1 ? (n.changeToPrevious = function() { o.jumpTo(s.getPreviousSlideIndex()) }, n.changeToNext = function() { o.jumpTo(s.getNextSlideIndex()) }) : (n.changeToPrevious = function() {}, n.changeToNext = function() {})
                }(e), U(e),
                function(e) {
                    var t = e.core,
                        n = t.classFacade,
                ...
                function(e) {
                    var t = e.collections,
                        ...
                        a = e.props,
                        l = e.stageIndexes;
                    s.runActions = function() { innerWidth < 992 ? r.maxSourceWidth = innerWidth : r.maxSourceWidth = .9 * innerWidth, r.maxSourceHeight = .9 * innerHeight, r.isFullscreenOpen && screen.height !== innerHeight && i.exitFullscreen(); for (var e = 0; e < a.sources.length; e++) B(c[e], u), e !== l.current && n[e].negative(), o[e] && o[e].styleSize() }
                }(e)
        }
        ...
        function ce() {
            for (var e = document.getElementsByTagName("a"), t = function(t) {
                    ...
                    function r(o, s) { e[t].hasAttribute(s) && (fsLightboxInstances[n].props[o][i] = e[t].getAttribute(s)) }
                    e[t].onclick = function(e) { e.preventDefault(), fsLightboxInstances[n].open(i) }, r("types", "data-type"), r("videosPosters", "data-video-poster"), r("customClasses", "data-custom-class")
